...
import signupAni from "../../lotties/signup.json";
...
const Register = () => {
  ...
  return (
    <div className="mb-14 text-primary-content">
      <Helmet>
        <title>Sign Up - Access Your Fixitronics Dashboard</title>
      </Helmet>
      <h3 className="text-3xl font-bold text-center mt-10">Sign up Now</h3>
      <div className="flex flex-col justify-center items-center">
        <div className="w-sm">
          <Lottie animationData={signupAni} loop={true}></Lottie>
        </div>
        <div className="card bg-base-200 w-full border max-w-sm mx-auto shrink-0 shadow-2xl">
          <div className="card-body">
            ...
            <button className="btn btn-primary" onClick={handleGoogle}>
              <p className="flex items-center justify-center gap-2">
                <RiGoogleFill size={20} /> <span> Continue with google</span>
              </p>
            </button>
          </div>
        </div>
