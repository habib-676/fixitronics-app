  ...
  return (
    <div className="min-w-11/12 mx-auto">
      ...
      >
        ...
        {slides.map((slide) => (
          <SwiperSlide className="min-h-[50vh] md:min-h-[60vh]">
            <div className="card bg-base-100 image-full w-72 md:w-96 h-full">
              <figure>
              ...
              <div className="card-body space-y-10 ">
                ...
                <button className="btn btn-accent">{slide.buttonText}</button>
              </div>
            </div>
          </SwiperSlide>
        ))}
